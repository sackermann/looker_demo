view: snowflake_demo2 {
  sql_table_name: PUBLIC.SNOWFLAKE_DEMO2 ;;
  ...
  dimension: hrsper_viewing_hh {
    type: number
    sql: ${TABLE}."HRSPER_VIEWING_HH" ;;
  }
  ...
  dimension: rating_by_channel_service_hh {
    type: number
    sql: ${TABLE}."RATING_BY_CHANNEL_SERVICE_HH" ;;
  }
